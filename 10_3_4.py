s = '''orange strawberry barley gooseberry apple apricot barley currant orange 
        ...
        apple barley apricot currant orange melon pomegranate banana banana orange 
        apricot barley plum banana grapefruit banana quince currant orange melon 
        pomegranate barley plum banana quince barley lime grapefruit pomegranate 
        barley
        '''

lst = s.split()
st = sorted(set(lst), key=lst.count, reverse=True)
print(st)
# нечестно: будет работать через раз
